...
export function LandingPage() {
  ...
  const handleContactSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.success('Thank you! Your message has been received and stored.');
  ...
  return (
    <div ref={containerRef} onMouseMove={handleMouseMove} className="relative min-h-screen bg-background text-foreground selection:bg-primary selection:text-primary-foreground overflow-hidden">
      ...
      <section id="home" className="relative z-10 pt-20 pb-24 md:pt-28 md:pb-36 lg:pt-36 lg:pb-48">
        <div className="container px-4 sm:px-6 lg:px-8 mx-auto flex flex-col items-center text-center">
          ...
          >
            <Badge variant="outline" className="mb-6 bg-card/60 border-border/80 backdrop-blur-md px-4 py-1.5 text-xs text-indigo-400 gap-1.5 shadow-inner">
            ...
            <h1 className="max-w-4xl text-5xl font-extrabold tracking-tight sm:text-6xl md:text-7xl lg:text-8xl leading-none">
              <span className="bg-gradient-to-b from-foreground/10 via-foreground/50 to-foreground bg-clip-text text-transparent block">
                Conduct Exams
              </span>
            ...
            <p className="mx-auto mt-8 max-w-2xl text-base leading-8 text-muted-foreground sm:text-lg md:text-xl font-normal">
            ...
            <div className="mt-12 flex flex-wrap items-center justify-center gap-5">
              ...
              <Button asChild size="lg" variant="outline" className="border-border bg-card/70 hover:bg-card/95 text-foreground rounded-full px-8 py-6 text-base backdrop-blur-sm shadow-lg transition-all hover:scale-105 active:scale-95">
          ...
          >
            ...
            <div className="rounded-2xl border border-border/80 bg-card/30 p-2 md:p-3 backdrop-blur-xl shadow-2xl shadow-black/15 dark:shadow-black/50">
              <div className="rounded-xl border border-border/60 bg-background/80 overflow-hidden shadow-inner">
                {/* Mock Window Header */}
                <div className="flex items-center justify-between px-4 py-3 bg-card/60 border-b border-border/60">
                  <div className="flex gap-1.5">
                    <span className="w-3 h-3 rounded-full bg-neutral-800" />
                    <span className="w-3 h-3 rounded-full bg-neutral-800" />
                    <span className="w-3 h-3 rounded-full bg-neutral-800" />
                  </div>
                  <div className="text-xs text-muted-foreground font-medium font-mono">oes-dashboard-preview.live</div>
                  <div className="w-12" />
                </div>
                {/* Mock Dashboard Body */}
                <div className="p-4 md:p-6 grid grid-cols-1 md:grid-cols-4 gap-4 text-left">
                  {/* Left Mock Nav */}
                  <div className="md:col-span-1 border-r border-border/80 pr-4 hidden md:flex flex-col gap-3">
                    <div className="h-6 w-2/3 bg-card rounded-md" />
                    <div className="space-y-2 mt-4">
                      <div className="h-5 bg-card rounded-md flex items-center px-2"><span className="w-2 h-2 rounded-full bg-primary/80 mr-2" /><span className="h-2 w-12 bg-neutral-800 rounded" /></div>
                      <div className="h-5 bg-transparent rounded-md flex items-center px-2"><span className="w-2 h-2 rounded-full bg-neutral-800 mr-2" /><span className="h-2 w-16 bg-card rounded" /></div>
                      <div className="h-5 bg-transparent rounded-md flex items-center px-2"><span className="w-2 h-2 rounded-full bg-neutral-800 mr-2" /><span className="h-2 w-10 bg-card rounded" /></div>
                      <div className="h-5 bg-transparent rounded-md flex items-center px-2"><span className="w-2 h-2 rounded-full bg-neutral-800 mr-2" /><span className="h-2 w-14 bg-card rounded" /></div>
                    </div>
                  </div>
                  {/* Right Mock Content */}
                  <div className="md:col-span-3 space-y-4">
                    <div className="flex justify-between items-center">
                      <div className="h-6 w-1/3 bg-card rounded-md" />
                      <div className="h-6 w-16 bg-card rounded-full" />
                    </div>
                    <div className="grid grid-cols-3 gap-3">
                      <div className="h-20 bg-card/60 border border-border/40 rounded-lg p-3 flex flex-col justify-between">
                    ...
                    {/* Mock Graph */}
                    <div className="h-44 bg-card/40 border border-border/40 rounded-lg p-4 flex flex-col justify-between">
            ...
            <motion.div
              ...
              className="absolute -top-6 -left-6 md:-left-12 bg-card/90 border border-border p-3 rounded-xl flex items-center gap-3 backdrop-blur shadow-xl shadow-black/10 dark:shadow-black/40"
            >
              ...
              <div className="text-left">
                ...
                <div className="text-[10px] text-muted-foreground">Live monitoring active</div>
              </div>
            </motion.div>
            ...
            <motion.div
              ...
              className="absolute -bottom-6 -right-6 md:-right-12 bg-card/90 border border-border p-3 rounded-xl flex items-center gap-3 backdrop-blur shadow-xl shadow-black/10 dark:shadow-black/40"
            >
              ...
              <div className="text-left">
                ...
                <div className="text-[10px] text-muted-foreground">Instant score audits</div>
              </div>
            </motion.div>
          </motion.div>
        </div>
      ...
      {/* Statistics Section */}
      <section className="relative z-10 py-16 border-y border-border bg-card/60 backdrop-blur-sm">
        <div className="container px-4 sm:px-6 lg:px-8 mx-auto">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-12 text-center">
            
            <div className="space-y-2">
              <div className="text-4xl md:text-5xl lg:text-6xl font-black bg-gradient-to-r from-foreground/10 via-foreground/50 to-foreground bg-clip-text text-transparent">
                <Counter value={stats.students} suffix="+" />
              </div>
              <div className="text-xs sm:text-sm font-semibold tracking-wider text-muted-foreground uppercase">Students</div>
            </div>
            ...
            <div className="space-y-2">
              ...
              <div className="text-xs sm:text-sm font-semibold tracking-wider text-muted-foreground uppercase">Exams Conducted</div>
            </div>
            ...
            <div className="space-y-2">
              ...
              <div className="text-xs sm:text-sm font-semibold tracking-wider text-muted-foreground uppercase">Instructors</div>
            </div>
            ...
            <div className="space-y-2">
              <div className="text-4xl md:text-5xl lg:text-6xl font-black bg-gradient-to-r from-blue-400 via-indigo-400 to-purple-500 bg-clip-text text-transparent">
                <Counter value={stats.questions} suffix="+" />
              </div>
              <div className="text-xs sm:text-sm font-semibold tracking-wider text-muted-foreground uppercase">Questions in Bank</div>
            </div>
      ...
      <section id="features" className="relative z-10 py-24 md:py-32">
        <div className="container px-4 sm:px-6 lg:px-8 mx-auto">
          ...
          <div className="mx-auto max-w-3xl text-center mb-20">
            ...
            <h2 className="text-3xl font-extrabold sm:text-4xl md:text-5xl bg-gradient-to-b from-foreground to-foreground/60 bg-clip-text text-transparent">
            ...
            {features.map((feature, idx) => {
              ...
              return (
                <motion.div
                  ...
                  whileHover={{ y: -6 }}
                  className="group relative rounded-2xl border border-border bg-card/70 p-6 backdrop-blur transition-all duration-300 hover:border-border hover:bg-card/40 overflow-hidden"
                >
                  ...
                  <div className={`flex h-12 w-12 items-center justify-center rounded-xl bg-gradient-to-br ${feature.color} shadow-inner`}>
      ...
      <section className="relative z-10 py-24 bg-background/40 border-y border-border">
        <div className="container px-4 sm:px-6 lg:px-8 mx-auto">
              ...
              <button
                ...
                className={`relative px-5 py-2.5 rounded-full text-sm font-semibold transition-all duration-300 ${
                  activeTab === tab.id
                    ...
                    : 'text-muted-foreground hover:text-foreground bg-card/50 hover:bg-card border border-border/80'
                }`}
              >
                {activeTab === tab.id && (
                  <motion.span
          ...
          <div className="border border-border bg-background/80 rounded-2xl p-4 md:p-6 shadow-2xl shadow-black/10 dark:shadow-black/50 relative min-h-[460px] flex items-center justify-center overflow-hidden">
            ...
            <AnimatePresence mode="wait">
              {activeTab === 'student' && (
                ...
                >
                  <div className="md:col-span-2 space-y-5">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-muted-foreground font-medium">Undergraduate Computer Science</p>
                      </div>
                    </div>
                    
                    <div className="border border-border/60 bg-card/20 rounded-xl p-4 space-y-3">
                      <div className="flex justify-between items-center">
                        <span className="text-sm font-bold text-muted-foreground">Upcoming Examination</span>
                        <Badge className="bg-amber-500/20 text-amber-400 font-bold border-none text-[10px]">SCHEDULED</Badge>
                      </div>
                      <div className="text-xl font-extrabold text-foreground">CS302: Database Management Systems</div>
                  ...
                  <div className="space-y-4">
                    <h5 className="font-bold text-sm text-muted-foreground uppercase tracking-wider">Dashboard Metrics</h5>
                    <div className="grid grid-cols-1 gap-3">
                      <div className="border border-border bg-card/30 p-4 rounded-xl flex items-center justify-between">
                        <div>
                          <p className="text-xs text-muted-foreground font-bold">Average Score</p>
                          <p className="text-2xl font-black mt-1 text-foreground">84%</p>
                        </div>
                        <TrendingUp className="h-8 w-8 text-emerald-500 bg-emerald-500/10 p-1.5 rounded-lg" />
                      </div>
                      <div className="border border-border bg-card/30 p-4 rounded-xl flex items-center justify-between">
                        <div>
                          <p className="text-xs text-muted-foreground font-bold">Completed Exams</p>
                          <p className="text-2xl font-black mt-1 text-foreground">12</p>
                        </div>
                ...
                >
                  <div className="flex justify-between items-center">
                    <div>
                      ...
                      <p className="text-xs text-muted-foreground">Subject: Relational Databases & SQL Queries</p>
                    </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div className="md:col-span-2 border border-border bg-card/20 p-5 rounded-xl space-y-4">
                      <div className="h-10 bg-background border border-border rounded-lg flex items-center justify-between px-3">
                        <span className="text-sm font-semibold text-muted-foreground">1. What is the default port of PostgreSQL?</span>
                        <Badge className="bg-blue-500/15 text-blue-400 border-none font-bold text-[10px]">EASY (1 Mark)</Badge>
                      </div>
                      <div className="h-10 bg-background border border-border rounded-lg flex items-center justify-between px-3">
                        <span className="text-sm font-semibold text-muted-foreground">2. Explain the third normal form (3NF) requirements.</span>
                        <Badge className="bg-amber-500/15 text-amber-400 border-none font-bold text-[10px]">MEDIUM (4 Marks)</Badge>
                      </div>
                      <div className="h-10 bg-background border border-border rounded-lg flex items-center justify-between px-3">
                        <span className="text-sm font-semibold text-muted-foreground">3. Write a query using nested joins to count...</span>
                        <Badge className="bg-rose-500/15 text-rose-400 border-none font-bold text-[10px]">HARD (5 Marks)</Badge>
                      </div>
                      <Button variant="outline" className="w-full border-dashed border-border bg-transparent text-muted-foreground">
                        + Add Question to Template
                      </Button>
                    </div>

                    <div className="border border-border bg-card/30 p-4 rounded-xl space-y-4">
                      <h5 className="font-bold text-sm text-muted-foreground">Exam Parameters</h5>
                      <div className="space-y-3 text-xs">
                        <div className="flex justify-between"><span className="text-muted-foreground">Duration Limit</span><span className="font-semibold text-muted-foreground">90 Mins</span></div>
                        <div className="flex justify-between"><span className="text-muted-foreground">Negative Marking</span><span className="font-semibold text-muted-foreground">0.25 Marks</span></div>
                        <div className="flex justify-between"><span className="text-muted-foreground">Fullscreen Required</span><span className="font-semibold text-emerald-400">TRUE</span></div>
                        <div className="flex justify-between"><span className="text-muted-foreground">Browser Lockdown</span><span className="font-semibold text-emerald-400">TRUE</span></div>
                      </div>
              ...
              {activeTab === 'admin' && (
                ...
                >
                  <div className="flex justify-between items-center">
                    <div>
                      <h4 className="font-bold text-lg text-foreground">System Monitoring & Logs</h4>
                      <p className="text-xs text-muted-foreground font-medium">Real-time coordinator dashboard</p>
                    </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                    <div className="border border-border bg-card/30 p-4 rounded-xl">
                      <p className="text-xs text-muted-foreground font-bold">Active Candidates</p>
                      <p className="text-2xl font-black text-foreground mt-1">1,482</p>
                    </div>
                    <div className="border border-border bg-card/30 p-4 rounded-xl">
                      <p className="text-xs text-muted-foreground font-bold">Server Load</p>
                      <p className="text-2xl font-black text-foreground mt-1">12%</p>
                    </div>
                    <div className="border border-border bg-card/30 p-4 rounded-xl">
                      <p className="text-xs text-muted-foreground font-bold">Socket Connections</p>
                      <p className="text-2xl font-black text-foreground mt-1">2,891</p>
                    </div>
                    <div className="border border-border bg-card/30 p-4 rounded-xl">
                      <p className="text-xs text-muted-foreground font-bold">Active Violations</p>
                  ...
                  <div className="border border-border bg-card/10 rounded-xl overflow-hidden">
                    <div className="bg-card/40 px-4 py-3 border-b border-border text-xs font-semibold text-muted-foreground flex justify-between">
                      <span>AUDIT LOG ACTION</span>
                      <span>TIME</span>
                    </div>
                    <div className="p-3 space-y-2 text-xs font-mono text-muted-foreground">
                      <div className="flex justify-between"><span>[AUTH] User register: student-e892@uni.edu</span><span className="text-muted-foreground">23:24:10</span></div>
                      <div className="flex justify-between"><span>[EXAM] Exam CS302 published by instructor-02</span><span className="text-muted-foreground">23:20:05</span></div>
                      <div className="flex justify-between"><span>[SUBM] Student cs-290 submitted exam result</span><span className="text-muted-foreground">23:18:41</span></div>
                    </div>
                  </div>
                </motion.div>
              )}
              ...
              {activeTab === 'exam' && (
                <motion.div
                  ...
                  exit={{ opacity: 0, x: -20 }}
                  transition={{ duration: 0.3 }}
                  className="w-full space-y-6 text-left border border-border/80 bg-background p-5 rounded-xl"
                >
                  <div className="flex items-center justify-between border-b border-border pb-3">
                    <div>
                      <h4 className="font-extrabold text-base text-foreground">CS302 Examination Terminal</h4>
                      <p className="text-[10px] text-muted-foreground font-bold tracking-wider">CANDIDATE ID: CS-2903</p>
                    </div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-1 gap-2.5">
                      <div className="bg-card/60 border border-border hover:border-border rounded-lg p-3 text-xs cursor-pointer flex items-center gap-3">
                        <span className="w-5 h-5 rounded-full border border-border bg-background flex items-center justify-center text-[10px] text-muted-foreground">A</span>
                        <span>NOT NULL</span>
                      </div>
                      ...
                      <div className="bg-card/60 border border-border hover:border-border rounded-lg p-3 text-xs cursor-pointer flex items-center gap-3">
                        <span className="w-5 h-5 rounded-full border border-border bg-background flex items-center justify-center text-[10px] text-muted-foreground">C</span>
                        <span>FOREIGN KEY</span>
                      </div>
                    </div>

                    <div className="flex justify-between items-center pt-2 border-t border-border text-xs">
                      <Button variant="outline" size="sm" className="border-border hover:bg-card rounded-lg text-[11px]">
                        Previous Question
                      </Button>
                      <div className="text-muted-foreground font-bold text-[10px] tracking-wide flex items-center gap-1.5">
              ...
              {activeTab === 'analytics' && (
                ...
                >
                  <div>
                    <h4 className="font-bold text-lg text-foreground">CS302 Exam Grade Distribution</h4>
                    <p className="text-xs text-muted-foreground">Instructor Report & Performance Analysis</p>
                  </div>

                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div className="md:col-span-2 h-56 border border-border bg-card/20 rounded-xl p-4 flex flex-col justify-between">
                      <div className="flex justify-between items-center text-xs text-muted-foreground">
                        <span>Score Brackets (%)</span>
                        <span>Candidate Count</span>
                      </div>
                      {/* CSS-based Bar Chart */}
                      <div className="flex items-end justify-between h-36 pt-4 border-b border-border">
                        <div className="w-[12%] h-[15%] bg-neutral-800 rounded-t flex flex-col justify-end items-center"><span className="text-[9px] text-muted-foreground mb-1">5</span></div>
                        <div className="w-[12%] h-[28%] bg-neutral-800 rounded-t flex flex-col justify-end items-center"><span className="text-[9px] text-muted-foreground mb-1">12</span></div>
                        ...
                        <div className="w-[12%] h-[40%] bg-neutral-800 rounded-t flex flex-col justify-end items-center"><span className="text-[9px] text-muted-foreground mb-1">18</span></div>
                      </div>
                    ...
                    <div className="border border-border bg-card/30 p-4 rounded-xl space-y-4 flex flex-col justify-center">
                      <div>
                        <span className="text-xs text-muted-foreground font-bold">Total Enrolled</span>
                        <h5 className="text-3xl font-black text-foreground mt-1">108 Students</h5>
                      </div>
                      <div>
                        <span className="text-xs text-muted-foreground font-bold">Passing Threshold</span>
                        <h5 className="text-3xl font-black text-indigo-400 mt-1">60%</h5>
                      </div>
                      <div>
                        <span className="text-xs text-muted-foreground font-bold">Passing Candidates</span>
      ...
      <section id="how-it-works" className="relative z-10 py-24 md:py-32">
        <div className="container px-4 sm:px-6 lg:px-8 mx-auto">
          ...
          {/* Stepper Timeline */}
          <div className="relative border-l border-border md:border-l-0 md:flex md:justify-between md:gap-4 max-w-5xl mx-auto pl-6 md:pl-0">
            ...
            {[
              ...
              >
                ...
                {idx < 4 && (
                  <div className="hidden md:block absolute top-6 left-12 right-0 h-[2px] bg-card -z-10" />
                )}

                <div className="flex h-12 w-12 items-center justify-center rounded-full border-2 border-border bg-background font-bold text-base text-primary shadow-lg shadow-primary/10 mb-5 md:mx-0">
                  {step.step}
                </div>
      ...
      {/* User Roles Section */}
      <section id="roles" className="relative z-10 py-24 md:py-32 bg-background/40 border-y border-border">
        <div className="container px-4 sm:px-6 lg:px-8 mx-auto">
          ...
          <div className="grid gap-8 md:grid-cols-3 max-w-5xl mx-auto">
            ...
            <motion.div
              whileHover={{ y: -6 }}
              className="rounded-2xl border border-border bg-background/60 p-8 backdrop-blur shadow-xl text-left flex flex-col justify-between"
            >
              <div>
                <Badge className="bg-primary/20 text-indigo-400 border-none font-bold text-[10px] px-2.5 py-1 mb-5">
                  ROLE: STUDENT
                </Badge>
                <h3 className="text-2xl font-bold text-foreground mb-4">Take Exams & Track Scores</h3>
                <p className="text-sm text-muted-foreground leading-relaxed mb-6">
                  Access examination dashboards securely, view detailed scorecards, and review previous grading remarks.
                </p>
                <Separator className="bg-card/60 mb-6" />
            ...
            <motion.div
              whileHover={{ y: -6 }}
              className="rounded-2xl border border-primary/30 bg-card/30 p-8 backdrop-blur shadow-2xl text-left flex flex-col justify-between relative"
            >
              ...
              <div>
                ...
                <h3 className="text-2xl font-bold text-foreground mb-4">Author Exams & Audit Grades</h3>
                <p className="text-sm text-muted-foreground leading-relaxed mb-6">
            ...
            >
              <div>
                ...
                <h3 className="text-2xl font-bold text-foreground mb-4">Manage System Operations</h3>
                <p className="text-sm text-muted-foreground leading-relaxed mb-6">
          ...
          <div className="grid gap-6 md:grid-cols-3 max-w-5xl mx-auto">
            ...
            {[
              ...
              <motion.div
                ...
                className="bg-card/30 border border-border p-6 rounded-2xl flex flex-col justify-between text-left backdrop-blur-md hover:border-border transition-colors"
              >
      ...
      {/* FAQ Section */}
      <section id="faq" className="relative z-10 py-24 md:py-32 bg-background/40 border-t border-border">
        <div className="container px-4 sm:px-6 lg:px-8 mx-auto">
          ...
          <Accordion type="single" collapsible className="max-w-3xl mx-auto space-y-3">
            {faqs.map((faq) => (
              <AccordionItem
                key={faq.question}
                value={faq.question}
                className="border border-border rounded-xl overflow-hidden bg-background/60 backdrop-blur-sm transition-all duration-300 hover:border-border/80"
              >
                <AccordionTrigger className="px-5 py-4 text-left font-bold text-sm sm:text-base text-foreground hover:text-foreground">
                  {faq.question}
                </AccordionTrigger>
                <AccordionContent className="p-5 pt-0 text-sm leading-relaxed text-muted-foreground border-t border-border bg-background/30">
                  {faq.answer}
                </AccordionContent>
              </AccordionItem>
            ))}
        ...
        <div className="container px-4 sm:px-6 lg:px-8 mx-auto">
          ...
          <div className="grid gap-12 lg:grid-cols-5 max-w-5xl mx-auto">
            ...
            <div className="lg:col-span-3">
              <form onSubmit={handleContactSubmit} className="glass-card border-border p-6 sm:p-8 rounded-2xl space-y-4 text-left">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="space-y-1.5">
                    ...
                    <input
                      ...
                      className="w-full bg-background border border-border rounded-lg px-4 py-2.5 text-xs text-foreground placeholder:text-muted-foreground focus:outline-none focus:border-primary transition-colors"
                    />
                  </div>
                  <div className="space-y-1.5">
                ...
                <div className="space-y-1.5">
                  <label htmlFor="message" className="text-xs font-bold text-muted-foreground uppercase tracking-wider">Message Description</label>
                  <textarea
                    id="message"
                    rows={4}
                    ...
                    className="w-full bg-background border border-border rounded-lg px-4 py-2.5 text-xs text-foreground placeholder:text-muted-foreground focus:outline-none focus:border-primary transition-colors resize-none"
                  />
                </div>
      ...
      {/* Footer */}
      <footer className="relative z-10 py-12 md:py-16 bg-background">
        <div className="container px-4 sm:px-6 lg:px-8 mx-auto grid grid-cols-2 md:grid-cols-4 gap-8 mb-12 text-left">
          ...
          <div className="space-y-3">
            <h6 className="text-xs font-bold text-muted-foreground uppercase tracking-widest">Product</h6>
          ...
          <div className="space-y-3">
            <h6 className="text-xs font-bold text-muted-foreground uppercase tracking-widest">Resources</h6>
            <ul className="space-y-2 text-xs text-muted-foreground">
          ...
          <div className="space-y-3">
            <h6 className="text-xs font-bold text-muted-foreground uppercase tracking-widest">Institution</h6>
            <ul className="space-y-2 text-xs text-muted-foreground">
        ...
        <div className="container px-4 sm:px-6 lg:px-8 mx-auto flex flex-col items-center justify-between gap-4 md:flex-row border-t border-border pt-8 text-xs text-muted-foreground">
          ...
          <div className="flex gap-4">
            ...
            <span className="hover:text-muted-foreground cursor-pointer">Terms of Service</span>
          </div>
        </div>
      </footer>

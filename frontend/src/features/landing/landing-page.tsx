    ...
    <div ref={containerRef} onMouseMove={handleMouseMove} className="relative min-h-screen bg-background text-foreground selection:bg-primary selection:text-primary-foreground overflow-hidden">
      ...
      <section id="home" className="relative z-10 pt-20 pb-24 md:pt-28 md:pb-36 lg:pt-36 lg:pb-48">
        <div className="container px-4 sm:px-6 lg:px-8 mx-auto flex flex-col items-center text-center">
          ...
          >
            ...
            <div className="rounded-2xl border border-border/80 bg-card/30 p-2 md:p-3 backdrop-blur-xl shadow-2xl shadow-black/80">
            ...
            <motion.div
              ...
              className="absolute -top-6 -left-6 md:-left-12 bg-card/90 border border-border p-3 rounded-xl flex items-center gap-3 backdrop-blur shadow-xl shadow-black/40"
            >
            ...
            <motion.div
              ...
              className="absolute -bottom-6 -right-6 md:-right-12 bg-card/90 border border-border p-3 rounded-xl flex items-center gap-3 backdrop-blur shadow-xl shadow-black/40"
            >
        ...
        <div className="container px-4 sm:px-6 lg:px-8 mx-auto">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-12 text-center">
            ...
            <div className="space-y-2">
              ...
              <div className="text-xs sm:text-sm font-semibold tracking-wider text-muted-foreground uppercase">Uptime / Availability</div>
            </div>
      ...
      <section className="relative z-10 py-24 bg-background/40 border-y border-border">
        <div className="container px-4 sm:px-6 lg:px-8 mx-auto">
          ...
          <div className="border border-border bg-background/80 rounded-2xl p-4 md:p-6 shadow-2xl shadow-black/60 relative min-h-[460px] flex items-center justify-center overflow-hidden">
          ...
          <div className="relative border-l border-border md:border-l-0 md:flex md:justify-between md:gap-4 max-w-5xl mx-auto pl-6 md:pl-0">
            ...
            {[
              ...
              >
                ...
                <div className="flex h-12 w-12 items-center justify-center rounded-full border-2 border-border bg-background font-bold text-base text-primary shadow-lg shadow-black/85 mb-5 md:mx-0">
                  {step.step}
                </div>
        ...
        <div className="container px-4 sm:px-6 lg:px-8 mx-auto">
          ...
          <div className="grid gap-12 lg:grid-cols-5 max-w-5xl mx-auto">
            ...
            <div className="lg:col-span-3">
              <form onSubmit={handleContactSubmit} className="bg-neutral-905 border border-border p-6 sm:p-8 rounded-2xl backdrop-blur-md space-y-4 text-left">

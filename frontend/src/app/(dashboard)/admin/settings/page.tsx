  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <h1 className="mt-3 text-3xl font-semibold tracking-normal">System settings</h1>
        ...
        <Card>
          ...
          <CardContent className="space-y-3">
            ...
            <div className="flex justify-between text-sm">
              ...
              <span className="font-mono text-xs">{process.env.NEXT_PUBLIC_JWT_EXPIRY || '15m'}</span>
            </div>
            <div className="flex justify-between text-sm">
              <span className="text-muted-foreground">Refresh token expiry</span>
              <span className="font-mono text-xs">{process.env.NEXT_PUBLIC_REFRESH_EXPIRY || '7d'}</span>
            </div>
            <div className="flex justify-between text-sm">
              <span className="text-muted-foreground">Rate limit (RPM)</span>
              <span className="font-mono text-xs">{process.env.NEXT_PUBLIC_RATE_LIMIT || '100'}</span>
            </div>
          </CardContent>
        </Card>

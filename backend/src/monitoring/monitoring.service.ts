...
export class MonitoringService {
  ...
  async saveConfig(examId: string, dto: Record<string, unknown>) {
    ...
    const data = {
      ...
      disableCopy: (dto.disableCopy as boolean | undefined) ?? stored?.disableCopy ?? true,
      disablePaste: (dto.disablePaste as boolean | undefined) ?? stored?.disablePaste ?? true,
  ...
  private mergeConfig(stored?: {
    ...
    return {
      ...
      disableCopy: stored?.disableCopy ?? true,
      disablePaste: stored?.disablePaste ?? true,
